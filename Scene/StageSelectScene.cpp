...
void StageSelectScene::Initialize() {
    ...
    btn = new Engine::ImageButton("play/play2.png", "play/play5.png", halfW - 250, halfH / 4, 500, 202.5);
    btn->SetOnClickCallback(std::bind(&StageSelectScene::PlayOnClick, this, 1));
    AddNewControlObject(btn);
    AddNewObject(new Engine::Label("Stage 1", "pirulen.ttf", 48, halfW, halfH / 2, 0, 0, 0, 255, 0.5, 0.5));
    btn = new Engine::ImageButton("play/play2.png", "play/play5.png", halfW - 250, halfH / 4 + 150, 500, 202.5);
    btn->SetOnClickCallback(std::bind(&StageSelectScene::PlayOnClick, this, 2));
    AddNewControlObject(btn);
    AddNewObject(new Engine::Label("Stage 2", "pirulen.ttf", 48, halfW, halfH / 2 +150, 0, 0, 0, 255, 0.5, 0.5));

    btn = new Engine::ImageButton("play/play2.png", "play/play5.png", halfW - 250, halfH / 4 + 300, 500, 202.5);
    ...
    btn = new Engine::ImageButton("play/play2.png", "play/play5.png", halfW - 250, halfH / 4 + 450, 500, 202.5);
    btn->SetOnClickCallback(std::bind(&StageSelectScene::BackOnClick, this, 1));
    AddNewControlObject(btn);
    AddNewObject(new Engine::Label("Back", "pirulen.ttf", 48, halfW, halfH * 3 / 2 + 30, 0, 0, 0, 255, 0.5, 0.5));
