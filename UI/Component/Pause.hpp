...
namespace Engine {
	...
	/// </summary>
	class PauseButton: public Image, public IControl {
	protected:
	...
	public:
      ...
      PlayScene* getPlayScene();
		...
		explicit PauseButton(std::string img, std::string imgIn, float x, float y, float w = 0, float h = 0, float anchorX = 0, float anchorY = 0);
		/// <summary>
